 ...
 */
final class Version20210706204826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO subscriber (id, \"name\", first_name, phone_number, email) 
            VALUES (1, 'Michel', 'Micou', '0658789645', 'micou@yahoo.fr'),
                ...
                (6, 'negative', 'man', '0644789645', 'man@yahoo.fr'),
                (7, 'nice', 'techno', '0644789645', 'techno@yahoo.fr'),
                (8, 'PHP', 'Expert', '0644789645', 'php@yahoo.fr'),
                (9, 'Okay', 'positive', '0644789645', 'positive@yahoo.fr'),
                (10, 'Zlatan', 'Ibra', '0644789645', 'ibra@yahoo.fr')"
        );
        $this->addSql("INSERT INTO event (id, start_date, end_date) 
        ...
        $this->addSql("INSERT INTO  event_subscriber (id, event_id, subscriber_id) 
            VALUES(1, 1, 1),
                (2, 1, 2),
                (3, 1, 3),
                (4, 1, 4),
